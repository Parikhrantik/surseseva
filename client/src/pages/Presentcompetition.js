                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                            ...
                            {Array.isArray(competitions?.data) && competitions.data.length > 0 ? (
                                competitions.data.filter((competition) => new Date(competition.endDate) >= new Date()).map((competition) => (
                                    ...
                                    <div
                                        key={competition._id}
                                        className="invition-card group bg-gradient-to-br
             from-white/5 to-white/0 backdrop-blur-lg rounded-2xl p-6 border border-white/10 hover:border-purple-500/50 
...
export default Presentcompetition