...
const EventDetail = () => {
    ...
    return (
        ...
        //   </div>
        <div className="max-w-6xl mx-auto">
            <div className=" rounded-lg shadow-md p-8 mb-8 mt-24">
                {loading ? (
                    <p className="text-gray-500 text-center">Loading event details...</p>
                ) : error ? (
                    <p className="text-red-500 text-center">{error}</p>
                    ...
                    <div className="main-event-details  rounded-lg overflow-hidden">
                        {/* Main Image - Fixed height container with full image display */}
                        
                        <div className='grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 gap-6'>
                            <div className='main-event-right'>
                                <div className="p-6">
                                <h1 className="text-3xl font-bold text-gray-800 mb-4">
                                    {event.title}
                                </h1>
